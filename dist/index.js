...
__export(src_exports, {
  ADToBS: () => ad2bs,
  BSToAD: () => bs2ad,
  MAX_ENG_DAY: () => MAX_ENG_DAY,
  MAX_ENG_MONTH: () => MAX_ENG_MONTH,
  MAX_ENG_YEAR: () => MAX_ENG_YEAR,
  MAX_NEP_DAY: () => MAX_NEP_DAY,
  MAX_NEP_MONTH: () => MAX_NEP_MONTH,
  MAX_NEP_YEAR: () => MAX_NEP_YEAR,
  MIN_ENG_DAY: () => MIN_ENG_DAY,
  MIN_ENG_MONTH: () => MIN_ENG_MONTH,
  MIN_ENG_YEAR: () => MIN_ENG_YEAR,
  MIN_NEP_DAY: () => MIN_NEP_DAY,
  MIN_NEP_MONTH: () => MIN_NEP_MONTH,
  MIN_NEP_YEAR: () => MIN_NEP_YEAR,
  ad2bs: () => ad2bs,
  bs2ad: () => bs2ad,
...
var ad2bs = (date) => {
  const total_days = (0, import_dayjs.default)(date).diff(en_ref_date, "day");
...
var bs2ad = (date) => {
  ...
  const en_date = (0, import_dayjs.default)(en_ref_date).add(resolved_total_days, "day").format("YYYY-MM-DD");
  return en_date;
};
